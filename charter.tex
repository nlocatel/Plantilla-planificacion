...
Tendrá un presupuesto preliminar estimado de 200 hs de trabajo y \textcolor{red}{\$XXX}, con fecha de inicio \fechaInicioName\hspace{1px} y fecha de presentación pública \fechaFinalName.
...
La organización GICSAFE se caracteriza por su misión de realizar proyectos con alto impacto social y económico.

En el marco del proyecto '\title', este subproyecto tiene por finalidad la realización de una interfaz de usuario web, que permita al personal encargado de los ensayos aplicados a los relés ferroviarios, configurar facilmente dichos ensayos y poder visualizar de forma resumida y clara los resultados de los mismos.
...
Impulsor      & GICSAFE           & GICSAFE        	& -        	\\ \hline
...
\item Vista de configuración de ensayos para los tipos 1, 2 y 3.
...
Para el desarrollo del presente proyecto supongo:
...
\item Grupo de requerimientos asociados con Usuarios:
	...
	\item Un usuario Administrador tendrá solo podrá administrar usuarios.
	\item Un usuario Configurador podrá ulitilzar la funcionalidad relativa a configuración de ensayos. 
	\item Un usuario de solo lectura podrá ulitilzar la funcionalidad relativa a la visualización de resultados.
	\end{enumerate}
...
\item Grupo de requerimientos asociados con Visualización de ensayos:
	...
	\item La pantalla de resultados de ensayos del relé mostrará los resultados de los ensayos en forma numérica y gráfica, de fácil interpretación.
	\end{enumerate}
...
\item Grupo de tareas relacionadas con el modelo
	...
	\item Crear API de acceso a datos. (8 hs)
	\item Revisar. (2 hs)
	\end{enumerate}
\item Grupo de tareas relacionadas con usuarios
	\begin{enumerate}
	\item Estudiar y agregar plugin de autenticación. (8 hs)
	\item Generar seed de usuario administrador.
	\item Estudiar plugin de roles. (8 hs)
	\item Agregar plugin de roles y definir roles. (8 hs)
	\item Revisar. (2 hs)
	\end{enumerate}
\item Grupo de tareas relacionadas con configuración de ensayos
	\begin{enumerate}
	\item Crear seeders con registros de prueba. (8 hs)
	\item Implementar solución en Nodered para la inserción de registros. (16 hs)
	\item Definir vistas de configuración. (8 hs)
...
\item Grupo de tareas relacionadas con visualización de ensayos
	...
	\item Diseñar vistas para cada tipo de ensayo. (8 hs)
	\item Implementar componente Vue para cada tipo. (24 hs)
	\item Revisar. (2 hs)
	\end{enumerate}
\end{enumerate}

Cantidad total de horas: (176 hs)
